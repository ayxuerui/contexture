    ...
    try {
      ...
      expect(calls).toEqual([
        ...
        [
          ...
          'resources/.gitkeep',
          'archives/.gitkeep',
          '.contexture/identity/posture.md',
          '.contexture/identity/world-facts.md',
          '.contexture/identity/user-facts.md',
          '.claude/skills/contexture-ingest-orchestration/SKILL.md',
          '.claude/skills/contexture-placement/SKILL.md',
          '.claude/skills/contexture-connection-finding/SKILL.md',
          '.claude/skills/contexture-organize-audit/SKILL.md',
          '.githooks/pre-commit',
          '.githooks/pre-push',
        ],
        ['diff', '--cached', '--quiet'],
