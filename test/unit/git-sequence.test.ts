    ...
    try {
      ...
      expect(calls).toEqual([
        ...
        [
          ...
          '.contexture/procedures/ingest-orchestration.md',
          '.contexture/procedures/placement.md',
          '.contexture/procedures/connection-finding.md',
          '.contexture/procedures/organize-audit.md',
          '.githooks/pre-commit',
          '.githooks/pre-push',
        ],
        ['diff', '--cached', '--quiet'],
