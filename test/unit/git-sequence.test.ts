    ...
    try {
      ...
      expect(calls).toEqual([
        ...
        [
          ...
          'archives/.gitkeep',
          'identity/posture.md',
          'identity/world-facts.md',
          'identity/user-facts.md',
          'procedures/ingest-orchestration.md',
          'procedures/placement.md',
          'procedures/connection-finding.md',
          'procedures/organize-audit.md',
          '.githooks/pre-commit',
          '.githooks/pre-push',
        ],
        ['diff', '--cached', '--quiet'],
