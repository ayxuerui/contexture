...
Extends the harness-portability capability (see `bootstrap-contexture-core`, `entry-doc-generation`): the contexture-owned skills carry audited decision procedures, not bare command sequences.
